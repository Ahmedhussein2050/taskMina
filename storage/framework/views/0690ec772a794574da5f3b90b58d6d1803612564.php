    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main_nav">
             <ul class="navbar-nav">
                        ...
                        <?php $__currentLoopData = App\Bll\Utility::mainNav(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $valuee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($valuee->products->isNotEmpty()): ?>
                                ...
                                <li><a class="dropdown-item"
                                        href="<?php echo e(route('category', $valuee->id)); ?>"><?php echo e($valuee->dataa->title ?? ''); ?>
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('page.get', 1)); ?>">
                        <?php echo e(_i('About')); ?> </a></li>

                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('contact_us.get')); ?>">
                        <?php echo e(_i('Contact Us')); ?> </a></li>

            </ul>
        </div> <!-- navbar-collapse.// -->
    </div> <!-- container-fluid.// -->
</nav>
<?php /**PATH C:\xampp\htdocs\taskMina\app\Modules\Portal\views/layout/nav.blade.php ENDPATH**/ ?>