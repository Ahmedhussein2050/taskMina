            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="single-section-item">
                    <a href="<?php echo e(route('category',$category->id)); ?>">
                        <div class="item-icon">
                            <img src="<?php echo e(asset($category->icon)); ?>" alt="" class="img-fluid" loading="lazy">
                        </div>
                        <h3 class="item-title">
...
<?php /**PATH C:\xampp\htdocs\mashora\app\Modules\portal\views/portal/include/category.blade.php ENDPATH**/ ?>