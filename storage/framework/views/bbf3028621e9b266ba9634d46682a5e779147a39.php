...
<head>
    ...
    <?php if(LaravelGettext::getLocale() == 'ar'): ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('portal/css/bootstrap.rtl.min.css')); ?>">
...
<?php /**PATH C:\xampp\htdocs\taskMina\app\Modules\Portal\views/layout/index.blade.php ENDPATH**/ ?>