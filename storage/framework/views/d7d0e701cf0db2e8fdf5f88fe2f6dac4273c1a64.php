					...
					<div class="modal-body">
						<form  action="<?php echo e(route('products.store.translation')); ?>" method="post" class="form-horizontal"  id="lang_submit" data-parsley-validate="">
							...
							<div class="box-body">
                                ...
                                <div class="form-group row">
									<label for="" class="col-sm-2 control-label "> <?php echo e(_i('Label')); ?> </label>
									<div class="col-md-10">
										<input type="text" name="label"  value="" class="form-control<?php echo e($errors->has('label') ? ' is-invalid' : ''); ?>" required="" id="label">
										<span class="text-danger">
...
<?php /**PATH C:\xampp\htdocs\mashora\app\Modules\Admin\views/admin/products/translate.blade.php ENDPATH**/ ?>