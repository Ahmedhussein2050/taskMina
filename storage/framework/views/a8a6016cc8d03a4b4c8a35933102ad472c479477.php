                    ...
                    <form id="edit_form" method="POST" class="j-pro" enctype="multipart/form-data"
                        ...
                        <div class="j-unit">
                            <div class="j-input">
                                ...
                                <textarea placeholder="<?php echo e(_i('tags')); ?>" id="tags1" class="form-control"
                                          name="tags"></textarea>
                            </div>
                            <span class="text-danger">
    ...
    <div class="modal fade" id="import-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="import_form" action="<?php echo e(route('products.import')); ?>" method="POST" class="j-pro" enctype="multipart/form-data"
...
'additionalPageUrl' => '' ,
'additionalPageName' => '',
] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taskMina\app\Modules\Admin\views/admin/products/index.blade.php ENDPATH**/ ?>