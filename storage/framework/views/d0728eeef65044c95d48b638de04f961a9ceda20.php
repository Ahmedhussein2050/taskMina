 <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($loop->index == 1): ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
    <?php if($section->type == 'best_selling_products' || ($section->type == 'latest_products' && $section->products()->isNotEmpty())): ?>
        <section class="products-section py-4 my-3">
            <div class="container">
                ...
                <div class="products-slider">
                     ...
                     <?php $__currentLoopData = $section->products()->where('stock', '>', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php elseif($section->type == 'random_products' && $section->products()->isNotEmpty()): ?>
        ...
        <?php endif; ?>
    <?php elseif($section->type == 'banner' && $section->banners->isNotEmpty()): ?>
        <section class="adv">
            <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $section->banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6">
                                <div class="single-wide-ad">
                                    <a href=""><img src="<?php echo e(asset($banner->image)); ?>" alt=""
                                            class="img-fluid w-100"></a>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\xampp\htdocs\taskMina\app\Modules\Portal\views/portal/include/home_section.blade.php ENDPATH**/ ?>