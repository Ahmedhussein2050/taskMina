        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3  d-flex justify-content-center justify-content-lg-end align-items-center gap-4">
                    ...
                    <?php if(auth()->check()): ?>
                        <div class="wishlist"><a href="<?php echo e(route('user.favourite')); ?>" id="wishlist"><i
...
<?php /**PATH C:\xampp\htdocs\taskMina\app\Modules\Portal\views/layout/header.blade.php ENDPATH**/ ?>