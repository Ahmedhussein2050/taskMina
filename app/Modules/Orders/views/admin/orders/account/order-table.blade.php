        ...
        @foreach ($order->orderProducts as $product)
            ...
            <tr>
                <td class="">
                    ...
                    <img src='@if ($product->product->thumbnail) {{ asset($product->product->thumbnail) }}@elseif($product->product->product_photos->first()) {{ asset($product->product->product_photos->first()->photo) }} @endif'
                        alt='' class="img-fluid" style="width: 80px">
                    <a class="text-primary" target="_blank"
{{--                        href="{{ route('home_product.show', [app()->getLocale(), $product->product_id]) }}"--}}
                        href="#"
                    >
