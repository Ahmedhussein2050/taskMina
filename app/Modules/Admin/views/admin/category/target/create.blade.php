...
[
    'title' => _i('Create Special Offer'),
    'subtitle' => _i('Create Special Offer'),
    'activePageName' => _i('Create Special Offer'),
    'activePageUrl' => route('offers.create'),
...
@section('content')
    ...
    <div class="page-body">
        <!-- Blog-card start -->
        <form  action="{{ route('offers.store')}}" method="post" class="form-horizontal" data-parsley-validate="" >
            @csrf
        <div class="row">
            <!------------------------------------- Offer details ----------------------------->
            <div class="col-sm-12">
