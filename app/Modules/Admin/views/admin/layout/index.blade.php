...
<head>
 ...
 <![endif]-->
    ...
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('admin_dashboard/assets/css/style.css') }}?q=<?= time() ?>">
    <!--color css-->
...
<![endif]-->
    ...
    {{-- <script src="{{ asset('admin_dashboard/bower_components/datatables.net-buttons/js/buttons.print.min.js') }}">
    </script>
    <script src="{{ asset('admin_dashboard/bower_components/datatables.net-buttons/js/buttons.html5.min.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ asset('admin_dashboard/assets/pages/advance-elements/swithces.js') }}">
    </script>
