		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form  action="{{url('admin/settings/banners/lang/store')}}" method="post" class="form-horizontal"  id="lang_submit" data-parsley-validate="">
						@csrf
						...
						<div class="box-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<textarea id="description_trans" class="form-control editor1" name="description" placeholder="{{_i('Place enter description here...')}}"></textarea>
								</div>
							</div>
