...
[
	'title' => _i('App Uses'),
	'subtitle' => _i('App Uses'),
	'activePageName' => _i('pp Uses'),
	'activePageUrl' => route('usages.index'),
...
<div class="box-body">
	<div class="row">
		<div class="col-sm-12 mb-3">
			...
			<span><i class="ti-plus"></i> {{_i('create new App Use')}} </span>
			</button>
			</span>
		</div>
		<div class="col-sm-12">
...
@include('admin.settings.usages.create')
@include('admin.settings.usages.edit')
@include('admin.settings.usages.trans')
@endsection
@push('js')
<script  type="text/javascript">
	...
	$(function () {
	    table = $('#slider_table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{url('admin/settings/usages')}}',
	        columns: [
	            {data: 'id'},
	            {data: 'name'},
	            {data: 'image'},
	...
	$('body').on('click','.lang_ex',function (e) {
	    ...
	    $.ajax({
	        url: '{{ url('admin/settings/usages/get/lang/value') }}',
	        method: "get",
	        data: {
	            lang_id: lang_id,
	            id: id,
