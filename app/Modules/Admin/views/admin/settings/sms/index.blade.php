...
[
	'title' => _i('SMS Settings'),
	'subtitle' => _i('SMS Settings'),
	'activePageName' => _i('SMS Settings'),
	'activePageUrl' => '',
					...
					<div class="">
						<form action="{{ route('sms.store') }}" method="post" class="j-forms" id="sms_store"
							...
							<div class="content">
								...
								<button type="button" class="btn btn-primary generateDocs text-center mb-3">{{ _i('Save') }}</button>
								<div class="form-group row">
									<div class="col-sm-12">
										<div class="downloadLetters" style="display: none">
											...
											<ul class="m-b-0 px-4 list-group">
												<li class="p-t-0 mb-2">
													<a href="{{ asset('uploads/sms//smsGeneralName.docx') ?? '' }}"
														download="">
													{{ _i('General sender name registration letter') }}</a>
												</li>
												<li class="mb-2">
													<a href="{{ asset('uploads/sms/smsAdName.docx') ?? '' }}"
