	...
	<div class="col-sm-12">
		<div class="card">
			...
			<div class="card-block">
				{!! $dataTable->table(['class'=> 'table table-striped table-bordered dataTable text-center'],true) !!}
			</div>
		</div>
	</div>
</div>
				...
				<div class="modal-body">
					<form  >
						<div class="box-body">
							...
							<div class="form-group row">
								<div class="col-md-12">
									<input type="text" readonly=""  placeholder="{{_i('Article Category Title')}}" name="title"  value=""
