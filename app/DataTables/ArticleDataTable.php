    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('edit', function($query){
                ...
                $html = '<a href="#" data-toggle="modal" data-target="#get_link" data-link="'.url('blog/'.$query->id).'" class="btn btn-default get_link"  title="' . _i("Show Link") . '">
                   <i class="ti-link"></i></a>  &nbsp;'.'';
                $html .= '<a href="'. url('master/articles/'.$query->id.'/edit') .'" id="item_id_' . $query->id . '" class="btn btn-primary"  title="' . _i("Edit") . '">
                   <i class="ti-pencil-alt"></i></a>  &nbsp;'.'
                   <form class=" delete"  action="'.url("master/articles/".$query->id) .'"  method="POST" id="deleteRow"  
                ...
                'buttons' => [
                    [
                        ...
                        'action' => 'function( e, dt, button, config){
                                                             window.location = "'.url('master/articles/create').'";
                                                         }',
                    ],
