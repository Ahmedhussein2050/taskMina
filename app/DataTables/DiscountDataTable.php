...
//            })
    ...
    {
        return $model->query()
            ->leftJoin('discounts_data', 'discounts_data.discount_id','discounts.id')
            //->where('discount_codes_items.discount_id', 'discount_codes.id')
            ->select('discounts.*','discounts_data.title as title' ,'discounts_data.label as label','discounts_data.currency as currency')
    ...
    {
        return [
            ['name'=>'discounts_data.title','data'=>'title','title'=>_i('Title')],
            ['name'=>'cover','data'=>'cover','title'=> _i('cover')],

            ['name'=>'discounts_data.label','data'=>'label','title'=> _i('label')],
