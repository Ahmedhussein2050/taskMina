...
class BlogsCatDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables($query)
            ...
            {
                $html = '<a href="' . url('admin/blog/categories/' . $query->id . '/edit') . '" id="item_id_' . $query->id . '" class="btn btn-primary"  title="' . _i("Edit") . '">
                   <i class="ti-pencil-alt"></i></a>  &nbsp;' . '
                   <form class=" delete"  action="' . url("admin/blog/categories/" . $query->id) . '"  method="POST" id="deleteRow" style="display: inline-block; right: 50px;">
                ...
                'buttons' => [
                    [
                        ...
                        'action' => 'function( e, dt, button, config){
                                                             window.location = "' . url('admin/blog/categories/create') . '";
                                                         }',
                    ],
